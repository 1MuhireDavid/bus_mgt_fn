...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const isGarageAttendant = data.user_roles.includes('Garage Attendant');
      // Redirect based on role
      const isAdmin = data.user_roles.includes('admin') || 
                     data.user_roles.includes('Company Admin') ||
                     data.is_superuser;
      
      router.push(isAdmin ? '/admin' : isGarageAttendant ? '/garage':'/conductor');
    } catch (error: any) {
